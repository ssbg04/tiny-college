    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                ...
                <li class="nav-item"><a class="nav-link" href="../../pages/school_manage/schools.php">Schools</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" style="text-decoration: underline orange 1px; color: white;" href="../../pages/professor_manage/professors.php">Professors</a></li>
